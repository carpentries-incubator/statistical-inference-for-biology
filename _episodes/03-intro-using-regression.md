...
# Instead, please edit 03-intro-using-regression.md in _episodes_rmd/
...
<img src="../fig/rmd-03-gravity-1.png" title="Simulated data for distance travelled versus time of falling object measured with error." alt="Simulated data for distance travelled versus time of falling object measured with error." width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-03-mice_weights-1.png" title="Mouse weights under two diets." alt="Mouse weights under two diets." width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-03-simulate_drop_data_with_fit-1.png" title="Fitted model for simulated data for distance travelled versus time of falling object measured with error." alt="Fitted model for simulated data for distance travelled versus time of falling object measured with error." width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-03-rss_versus_estimate-1.png" title="Residual sum of squares obtained for several values of the parameters." alt="Residual sum of squares obtained for several values of the parameters." width="612" style="display: block; margin: auto;" />
