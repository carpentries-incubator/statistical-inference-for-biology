...
# Instead, please edit 13-eda-avoid-plots.md in _episodes_rmd/
...
<img src="../fig/rmd-13-piechart-1.png" title="Pie chart of browser usage." alt="Pie chart of browser usage." width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-barplot-1.png" title="Barplot of browser usage." alt="Barplot of browser usage." width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-importance_of_log-1.png" title="Data and boxplots for original data (left) and in log scale (right)." alt="Data and boxplots for original data (left) and in log scale (right)." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-show-data-1.png" title="The plot on the left shows a regression line that was fitted to the data shown on the right. It is much more informative to show all the data." alt="The plot on the left shows a regression line that was fitted to the data shown on the right. It is much more informative to show all the data." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-correlation-not-replication-1.png" title="Gene expression data from two replicated samples. Left is in original scale and right is in log scale." alt="Gene expression data from two replicated samples. Left is in original scale and right is in log scale." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-MAplot-1.png" title="MA plot of the same data shown above shows that data is not replicated very well despite a high correlation." alt="MA plot of the same data shown above shows that data is not replicated very well despite a high correlation." width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-scatter-plot-for-two-vars-1.png" title="For two variables a scatter plot or a 'rotated' plot similar to an MA plot is much more informative." alt="For two variables a scatter plot or a 'rotated' plot similar to an MA plot is much more informative." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-lines-plot-box-plot-1.png" title="Another alternative is a line plot. If we don't care about pairings, then the boxplot is appropriate." alt="Another alternative is a line plot. If we don't care about pairings, then the boxplot is appropriate." width="756" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-colors-for-different-lines-1.png" title="This plot demonstrates that using color is more than enough to distinguish the three lines." alt="This plot demonstrates that using color is more than enough to distinguish the three lines." width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-13-show-important-factors-1.png" title="Because dose is an important factor, we show it in this plot." alt="Because dose is an important factor, we show it in this plot." width="612" style="display: block; margin: auto;" />
