...
# Instead, please edit 06-matrix-algebra-examples.md in _episodes_rmd/
...
~~~
Error in popvar(y): object 'y' not found
~~~
{: .error}
...
<img src="../fig/rmd-06-gravity_with_fitted_parabola-1.png" title="Fitted parabola to simulated data for distance travelled versus time of falling object measured with error." alt="Fitted parabola to simulated data for distance travelled versus time of falling object measured with error." width="612" style="display: block; margin: auto;" />
