...
# Instead, please edit 16-matrixAlg-operations.md in _episodes_rmd/
...
Exercises1.SupposeXis a matrix in R. Which of the following isnotequivalent toX?•A)t( t(X) )•B)X %*% matrix(1,ncol(X) )•C)X*1•D)X%*%diag(ncol(X))2.Solve the following system of equations using R:3a+ 4b
